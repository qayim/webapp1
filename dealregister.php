<?php
	...
	if (isset($_POST['insert'])) {
		...
		if (strlen($_POST['dname']) < 1) {
            ...
            $stmt = $pdo->prepare('INSERT INTO deal (dcode, dname, dlogo, dcompany, daddress, dpostal, dcountry, dtagline, ddesc, damount, dunit, start, end, dcountrysupp, phone) VALUES (:dcode, :dname, :dlogo, :dcompany, :daddress, :dpostal, :dcountry, :dtagline, :ddesc, :damount, :dunit, :start, :end, :dcountrysupp, :phone)');
