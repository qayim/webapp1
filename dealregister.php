<?php
	...
	if (isset($_POST['insert'])) {
		...
		if (strlen($_POST['dname']) < 1) {
            ...
            $stmt = $pdo->prepare('INSERT INTO deal (dcode, dname, dlogo, dcompany, daddress, dpostal, dcountry, dtagline, ddesc, damount, dunit, start, end, dcountrysupp, phone, dactivate, dcomment, dverify, duploaddate) VALUES (:dcode, :dname, :dlogo, :dcompany, :daddress, :dpostal, :dcountry, :dtagline, :ddesc, :damount, :dunit, :start, :end, :dcountrysupp, :phone, :dactivate, :dcomment, :dverify, :duploaddate)');
				...
				?>
                    ...
                    <form method="POST" enctype="multipart/form-data">
						...
						<p class="dlogo">Deal unit: </p>
							<input type="radio" id="rm" name="dunit" value="RM" style="height:35px; width:35px; vertical-align: middle;">
